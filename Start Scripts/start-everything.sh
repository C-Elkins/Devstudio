...
start_service "start-api.sh" "Control Center API" "3001"

echo "5️⃣ Starting Control Center GUI..."
start_service "start-control-center.sh" "Control Center GUI" "5173"

echo "🎉 All services started!"
echo "=================================="
echo "🌐 Frontend:        http://localhost:3000"
echo "🔧 Backend API:     http://localhost:5002"
echo "🎛️  Control Center:  http://localhost:5173"
echo "📊 API Management:  http://localhost:3001"
echo "🗄️  Database:       mongodb://localhost:27017"
echo ""
echo "💡 Use Control Center (http://localhost:5173) to manage all services"
